...
#             print count
             ...
             if row[10] != '     nan':
                 salinity[0,nn,0,1,count]=float(row[10])
             if row[11] != '     nan':
                 salinity[0,nn,1,1,count]=float(row[11])
             if row[12] != '     nan':
                 salinity[0,nn,2,1,count]=float(row[12])
             if row[13] != '     nan':
                 salinity[0,nn,3,1,count]=float(row[13])
             if row[14] != '     nan':
                 salinity[0,nn,4,1,count]=float(row[14])
             if row[15] != '     nan':
                 salinity[0,nn,5,1,count]=float(row[15])
             if row[16] != '     nan':
                 salinity[0,nn,6,1,count]=float(row[16])
             if row[17] != '     nan':
                 salinity[0,nn,7,1,count]=float(row[17])
             if row[18] != '     nan':
                 salinity[0,nn,8,1,count]=float(row[18])
             if row[19] != '     nan':
                 salinity[0,nn,0,5,count]=float(row[19])
             if row[20] != '     nan':
                 salinity[0,nn,1,5,count]=float(row[20])
             if row[21] != '     nan':
                 salinity[0,nn,2,5,count]=float(row[21])
             if row[22] != '     nan':
                 salinity[0,nn,3,5,count]=float(row[22])
             if row[23] != '     nan':
                 salinity[0,nn,4,5,count]=float(row[23])
             if row[24] != '     nan':
                 salinity[0,nn,5,5,count]=float(row[24])
             if row[25] != '     nan':
                 salinity[0,nn,6,5,count]=float(row[25])
             if row[26] != '     nan':
                 salinity[0,nn,7,5,count]=float(row[26])
             if row[27] != '     nan':
                 salinity[0,nn,8,5,count]=float(row[27])
             if row[28] != '     nan':
                 salinity[0,nn,0,2,count]=float(row[28])
             if row[29] != '     nan':
                 salinity[0,nn,1,2,count]=float(row[29])
             if row[30] != '     nan':
                 salinity[0,nn,2,2,count]=float(row[30])
             if row[31] != '     nan':
                 salinity[0,nn,3,2,count]=float(row[31])
             if row[32] != '     nan':
                 salinity[0,nn,4,2,count]=float(row[32])
             if row[33] != '     nan':
                 salinity[0,nn,5,2,count]=float(row[33])
             if row[34] != '     nan':
                 salinity[0,nn,6,2,count]=float(row[34])
             if row[35] != '     nan':
                 salinity[0,nn,7,2,count]=float(row[35])
             if row[36] != '     nan':
                 salinity[0,nn,8,2,count]=float(row[36])
             if row[37] != '     nan':
                 salinity[0,nn,0,6,count]=float(row[37])
             if row[38] != '     nan':
                 salinity[0,nn,1,6,count]=float(row[38])
             if row[39] != '     nan':
                 salinity[0,nn,2,6,count]=float(row[39])
             if row[40] != '     nan':
                 salinity[0,nn,3,6,count]=float(row[40])
             if row[41] != '     nan':
                 salinity[0,nn,4,6,count]=float(row[41])
             if row[42] != '     nan':
                 salinity[0,nn,5,6,count]=float(row[42])
             if row[43] != '     nan':
                 salinity[0,nn,6,6,count]=float(row[43])
             if row[44] != '     nan':
                 salinity[0,nn,7,6,count]=float(row[44])
             if row[45] != '     nan':
                 salinity[0,nn,8,6,count]=float(row[45])
             if row[46] != '     nan':
                 salinity[0,nn,0,7,count]=float(row[46])
             if row[47] != '     nan':
                 salinity[0,nn,1,7,count]=float(row[47])
             if row[48] != '     nan':
                 salinity[0,nn,2,7,count]=float(row[48])
             if row[49] != '     nan':
                 salinity[0,nn,3,7,count]=float(row[49])
             if row[50] != '     nan':
                 salinity[0,nn,4,7,count]=float(row[50])
             if row[51] != '     nan':
                 salinity[0,nn,5,7,count]=float(row[51])
             if row[52] != '     nan':
                 salinity[0,nn,6,7,count]=float(row[52])
             if row[53] != '     nan':
                 salinity[0,nn,7,7,count]=float(row[53])
             if row[54] != '     nan':
                 salinity[0,nn,8,7,count]=float(row[54])
             count=count+1
...
#             print count
             ...
             if row[19] != '     nan':
                 salinity[0,nn,0,0,count]=float(row[19])
             if row[20] != '     nan':
                 salinity[0,nn,1,0,count]=float(row[20])
             if row[21] != '     nan':
                 salinity[0,nn,2,0,count]=float(row[21])
             if row[22] != '     nan':
                 salinity[0,nn,3,0,count]=float(row[22])
             if row[23] != '     nan':
                 salinity[0,nn,4,0,count]=float(row[23])
             if row[24] != '     nan':
                 salinity[0,nn,5,0,count]=float(row[24])
             if row[25] != '     nan':
                 salinity[0,nn,6,0,count]=float(row[25])
             if row[26] != '     nan':
                 salinity[0,nn,7,0,count]=float(row[26])
             if row[27] != '     nan':
                 salinity[0,nn,8,0,count]=float(row[27])
             count=count+1
    return salinity
...
depth=np.array([10,30,60,100,150,300,600,1000,2000])
...
stats_salinity.units = "1e-3"
salinity=np.ones((1,1,9,8,17))
