...
edge=int(edge)
dep=np.array([0.0,10.0,30.0,60.0,100.0,150.0,400.0,600.0,1000.0,2000.0])
...
if exper=="0":
    for ii in range(int(nregs)+1):
        ...
        if (ii==0):
            if instr=="INSITU":
                linea=np.concatenate((var_mod_lvl,mean_mod_lvl,var_obs_lvl,mean_obs_lvl,cov_m_o_lvl,[0. ,0. ,0. ,0. ,0. ,0. ,0. ,0. ,0.]),axis=0)
            else:
...
if exper=="0":
    for ii in range(int(nregs)+1):
        ...
        if (ii==0):
            if instr=="INSITU":
                linea=np.concatenate((var_mod_aggr_lvl,mean_mod_lvl,var_obs_aggr_lvl,mean_obs_lvl,cov_m_o_aggr_lvl,[0. ,0. ,0. ,0. ,0. ,0. ,0. ,0. ,0.]),axis=0)
            else:
