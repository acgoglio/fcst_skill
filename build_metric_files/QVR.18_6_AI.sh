...
#InDir=$1
WorkDir=/work/oda/ag15419/tmp/Ana_Fcst/AI/work/ #Da modificare
#LogDir=$3
OutDir=/work/oda/ag15419/tmp/Ana_Fcst/AI/out/ #Da modificare
...
ProcDay=20210801 # Eventualmente da modificare
...
MYE_DELIVERY2=/data/inputs/metocean/historical/model/ocean/CMCC/MedFormer/forecast/ #Directory dove sono archiviati i file da utilizzare
...
#    bestest=`find -L $MYE_DELIVERY2/$diran -name {NRT_SYSNAME}*-${day}-a-T.nc`
    dayfc1=`python ${BinDir}/jday.py ${day} -1`
    dayfc2=`python ${BinDir}/jday.py ${day} -2`
    dayfc3=`python ${BinDir}/jday.py ${day} -3`
    dayfc4=`python ${BinDir}/jday.py ${day} -4`
    dayfc5=`python ${BinDir}/jday.py ${day} -5`
    dayfc6=`python ${BinDir}/jday.py ${day} -6`
    dayfc7=`python ${BinDir}/jday.py ${day} -7`
    dayfc8=`python ${BinDir}/jday.py ${day} -7`
    dayfc9=`python ${BinDir}/jday.py ${day} -7`
    dayfc10=`python ${BinDir}/jday.py ${day} -7`
    # Da decidere la climatologia
    cl=`find -L ${VAL_WORKDIR}/QVR_DATA0/ -name ${NRT_SYSNAME_CL}-20210301-2019${mm}01-a-T.nc`
    # Da modificare 95-116 in base a nome file utilizzati
    bestest=`find -L $MYE_DELIVERY2/$diran -name ${NRT_SYSNAME}*_${dayb}_*grid_T.nc`
    sm=`find -L $MYE_DELIVERY2/${dayfc1:0:4}/${dayfc1:4:2}/${dayfc1:6:2} -name ${NRT_SYSNAME}*_${day}_*grid_T.nc`
    fc1=`find -L $MYE_DELIVERY2/${dayfc1:0:4}/${dayfc1:4:2}/${dayfc1:6:2} -name ${NRT_SYSNAME}*_${day}_*grid_T.nc`
    ps1=`find -L $MYE_DELIVERY2/${dayfc1:0:4}/${dayfc1:4:2}/${dayfc1:6:2} -name ${NRT_SYSNAME}*_${day}_*grid_T.nc`
    fc2=`find -L $MYE_DELIVERY2/${dayfc2:0:4}/${dayfc2:4:2}/${dayfc2:6:2} -name ${NRT_SYSNAME}*_${day}_*grid_T.nc`
    ps2=`find -L $MYE_DELIVERY2/${dayfc2:0:4}/${dayfc2:4:2}/${dayfc2:6:2} -name ${NRT_SYSNAME}*_${dayfc1}_*grid_T.nc`
    echo "fc1 $fc1"
    echo "fc2 $fc2"
    echo "ps1 $ps1"
    echo "ps2 $ps2"
    fc3=`find -L $MYE_DELIVERY2/${dayfc3:0:4}/${dayfc3:4:2}/${dayfc3:6:2} -name ${NRT_SYSNAME}*_${day}_*grid_T.nc`
    ps3=`find -L $MYE_DELIVERY2/${dayfc3:0:4}/${dayfc3:4:2}/${dayfc3:6:2} -name ${NRT_SYSNAME}*_${dayfc2}_*grid_T.nc`
    fc4=`find -L $MYE_DELIVERY2/${dayfc4:0:4}/${dayfc4:4:2}/${dayfc4:6:2} -name ${NRT_SYSNAME}*_${day}_*grid_T.nc`
    ps4=`find -L $MYE_DELIVERY2/${dayfc4:0:4}/${dayfc4:4:2}/${dayfc4:6:2} -name ${NRT_SYSNAME}*_${dayfc3}_*grid_T.nc`
    fc5=`find -L $MYE_DELIVERY2/${dayfc5:0:4}/${dayfc5:4:2}/${dayfc5:6:2} -name ${NRT_SYSNAME}*_${day}_*grid_T.nc`
    ps5=`find -L $MYE_DELIVERY2/${dayfc5:0:4}/${dayfc5:4:2}/${dayfc5:6:2} -name ${NRT_SYSNAME}*_${dayfc4}_*grid_T.nc`
    fc6=`find -L $MYE_DELIVERY2/${dayfc6:0:4}/${dayfc6:4:2}/${dayfc6:6:2} -name ${NRT_SYSNAME}*_${day}_*grid_T.nc`
    ps6=`find -L $MYE_DELIVERY2/${dayfc6:0:4}/${dayfc6:4:2}/${dayfc6:6:2} -name ${NRT_SYSNAME}*_${dayfc5}_*grid_T.nc`
    fc7=`find -L $MYE_DELIVERY2/${dayfc7:0:4}/${dayfc7:4:2}/${dayfc7:6:2} -name ${NRT_SYSNAME}*_${day}_*grid_T.nc`
    ps7=`find -L $MYE_DELIVERY2/${dayfc7:0:4}/${dayfc7:4:2}/${dayfc7:6:2} -name ${NRT_SYSNAME}*_${dayfc6}_*grid_T.nc`
    fc8=`find -L $MYE_DELIVERY2/${dayfc8:0:4}/${dayfc8:4:2}/${dayfc8:6:2} -name ${NRT_SYSNAME}*_${day}_*grid_T.nc`
    ps8=`find -L $MYE_DELIVERY2/${dayfc8:0:4}/${dayfc8:4:2}/${dayfc8:6:2} -name ${NRT_SYSNAME}*_${dayfc7}_*grid_T.nc`
    fc9=`find -L $MYE_DELIVERY2/${dayfc9:0:4}/${dayfc9:4:2}/${dayfc9:6:2} -name ${NRT_SYSNAME}*_${day}_*grid_T.nc`
    ps9=`find -L $MYE_DELIVERY2/${dayfc9:0:4}/${dayfc9:4:2}/${dayfc9:6:2} -name ${NRT_SYSNAME}*_${dayfc8}_*grid_T.nc`
    fc10=`find -L $MYE_DELIVERY2/${dayfc10:0:4}/${dayfc10:4:2}/${dayfc10:6:2} -name ${NRT_SYSNAME}*_${day}_*grid_T.nc`
    ps10=`find -L $MYE_DELIVERY2/${dayfc10:0:4}/${dayfc10:4:2}/${dayfc10:6:2} -name ${NRT_SYSNAME}*_${dayfc9}_*grid_T.nc`
    lcl=mfs_easO-20210301-2019${mm}01-a-T.nc
    # esempio di file finale mfs_easO-20220529-20220601-f-T.nc
    #                       medformer_fc_1d_20210802_grid_T.nc
    bbestest=mfs_aiai-${ProcDay}-${day}-a-T.nc
    bsm=mfs_aiai-${day}-${day}-s-T.nc
    echo "Prova 0 ${day} ${dayfc1} "
    echo "Prova 1 $fc1"
    bfc1=mfs_aiai-${dayfc1:0:4}${dayfc1:4:2}${dayfc1:6:2}-${day}-f-T.nc
    echo "Prova 2 $bfc1"
    bfc2=mfs_aiai-${dayfc2:0:4}${dayfc2:4:2}${dayfc2:6:2}-${day}-f-T.nc
    bfc3=mfs_aiai-${dayfc3:0:4}${dayfc3:4:2}${dayfc3:6:2}-${day}-f-T.nc
    bfc4=mfs_aiai-${dayfc4:0:4}${dayfc4:4:2}${dayfc4:6:2}-${day}-f-T.nc
    bfc5=mfs_aiai-${dayfc5:0:4}${dayfc5:4:2}${dayfc5:6:2}-${day}-f-T.nc
    bfc6=mfs_aiai-${dayfc6:0:4}${dayfc6:4:2}${dayfc6:6:2}-${day}-f-T.nc
    bfc7=mfs_aiai-${dayfc7:0:4}${dayfc7:4:2}${dayfc7:6:2}-${day}-f-T.nc
    bfc8=mfs_aiai-${dayfc8:0:4}${dayfc8:4:2}${dayfc8:6:2}-${day}-f-T.nc
    bfc9=mfs_aiai-${dayfc9:0:4}${dayfc9:4:2}${dayfc9:6:2}-${day}-f-T.nc
    bfc10=mfs_aiai-${dayfc10:0:4}${dayfc10:4:2}${dayfc10:6:2}-${day}-f-T.nc
    bps1=mfs_aiai-${dayfc1:0:4}${dayfc1:4:2}${dayfc1:6:2}-${dayfc1}-f-T.nc
    bps2=mfs_aiai-${dayfc2:0:4}${dayfc2:4:2}${dayfc2:6:2}-${dayfc2}-f-T.nc
    bps3=mfs_aiai-${dayfc3:0:4}${dayfc3:4:2}${dayfc3:6:2}-${dayfc3}-f-T.nc
    bps4=mfs_aiai-${dayfc4:0:4}${dayfc4:4:2}${dayfc4:6:2}-${dayfc4}-f-T.nc
    bps5=mfs_aiai-${dayfc5:0:4}${dayfc5:4:2}${dayfc5:6:2}-${dayfc5}-f-T.nc
    bps6=mfs_aiai-${dayfc6:0:4}${dayfc6:4:2}${dayfc6:6:2}-${dayfc6}-f-T.nc
    bps7=mfs_aiai-${dayfc7:0:4}${dayfc7:4:2}${dayfc7:6:2}-${dayfc7}-f-T.nc
    bps8=mfs_aiai-${dayfc8:0:4}${dayfc8:4:2}${dayfc8:6:2}-${dayfc8}-f-T.nc
    bps9=mfs_aiai-${dayfc9:0:4}${dayfc9:4:2}${dayfc9:6:2}-${dayfc9}-f-T.nc
    bps10=mfs_aiai-${dayfc10:0:4}${dayfc10:4:2}${dayfc10:6:2}-${dayfc10}-f-T.nc
