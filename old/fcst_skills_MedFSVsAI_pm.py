...
for var_idx,var in enumerate(input_vars):
       ...
       for depth_idx,depth in enumerate(depths):
         ...
         for field_idx,field in enumerate(fields): 
           ...
           if field == -156 or field == -132 or field == -108 or field == -84 or field == -60 or field == -36 or field == -12 or field == 12 or field == 36 or field == 60 or field == 84 or field == 108 or field == 132 or field == 156 :
             ...
             try:
                ...
                #print ('PROVA RMSD 1: ',globals()['rmsd_1_'+str(field)+'_'+str(depth)+'_'+var+'_'+str(area_code)])
                #print ('PROVA MEAN RMSD 1: ', np.nanmean(globals()['rmsd_1_'+str(field)+'_'+str(depth)+'_'+var+'_'+str(area_code)]))
             ...
             try:
                ...
                #print ('PROVA RMSD 2: ',globals()['rmsd_2_'+str(field)+'_'+str(depth)+'_'+var+'_'+str(area_code)])
                #print ('PROVA MEAN RMSD 2: ', np.nanmean(globals()['rmsd_2_'+str(field)+'_'+str(depth)+'_'+var+'_'+str(area_code)]))
             # If the values are nans
             except:
             ...
             try:
                ...
                #print ('PROVA ACC 1: ',globals()['acc_1_'+str(field)+'_'+str(depth)+'_'+var+'_'+str(area_code)])
                #print ('PROVA MEAN ACC 1: ', np.nanmean(globals()['acc_1_'+str(field)+'_'+str(depth)+'_'+var+'_'+str(area_code)]))
             # If the values are nans
             except:
             ...
             try:
                ...
                #print ('PROVA ACC 2: ',globals()['acc_2_'+str(field)+'_'+str(depth)+'_'+var+'_'+str(area_code)])
                #print ('PROVA MEAN ACC 2: ', np.nanmean(globals()['acc_2_'+str(field)+'_'+str(depth)+'_'+var+'_'+str(area_code)]))
             # If the values are nans
             except:
         ...
         if flag_ts == 1 :
            ...
            plt.rc('font', size=10)
            fig_name = workdir+var+'_RMSD_'+str(depths_defn[depth_idx])+'_'+str(start_date)+'-'+str(end_date)+'_'+str(area_code)+'_nopers.png'
            print ('Plot: ',fig_name)
            ...
            #ylabel("N. OBS",fontsize=16,color="white")
            ...
            for field_idx,field in enumerate(fields_2_include):
                # Work only on required fields
                   if flag_rolling_mean == 1:
                      ...
                      mean_li = np.mean(li)
                   #q11 = pd.DataFrame(globals()['rmsd_1_'+str(field)+'_'+str(depth)+'_'+var+'_'+str(area_code)]).rolling(rolling_mean_days).quantile(0.25)
                   #q31 = pd.DataFrame(globals()['rmsd_1_'+str(field)+'_'+str(depth)+'_'+var+'_'+str(area_code)]).rolling(rolling_mean_days).quantile(0.75)
                   ...
                   # TMP to remove the persistence:
                   if field_idx > 6 :
                      globals()['line_'+str(field_idx)] = ax.plot(time_var,li,color=colors[field_idx-7],label=fields_defn_ts[field_idx]+' '+dataset_names[0]+' mean='+str(round(mean_li,3))+udm[var_idx],marker='o',linestyle='-',linewidth=1.5)
                      #globals()['line_'+str(field_idx)] = ax.plot(time_var,li,color=colors[field_idx-7],label=fields_defn_ts[field_idx]+' '+dataset_names[0]+' mean='+str(round(mean_li,3))+udm[var_idx]+'(t0='+str(np.round(li[0],3))+udm[var_idx]+')',marker='o',linestyle='-',linewidth=1.5)
                   ...
                   #q11_2 = pd.DataFrame(globals()['rmsd_1_'+str(field)+'_'+str(depth)+'_'+var+'_'+str(area_code)]).rolling(rolling_mean_days).quantile(0.25)
                   #q31_2 = pd.DataFrame(globals()['rmsd_1_'+str(field)+'_'+str(depth)+'_'+var+'_'+str(area_code)]).rolling(rolling_mean_days).quantile(0.75)
                   ...
                   #q1q3_2=np.squeeze(np.array([[q11_2],[q31_2]]))
